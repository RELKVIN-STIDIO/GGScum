...
public partial class FirstPersonController : MonoBehaviour
{
    ...
    private float maxXRotation = 360f;
    ...
    private void Update()
    {
        ...
        if (isLook)
        {
            ...
            if (minXRotation != -360f || maxXRotation != 360f)
            {
    ...
    public void SetCameraRotationLimits(float minX, float maxX, float minY, float maxY)
    {
        minXRotation = minX;
        maxXRotation = maxX;
        minYRotation = minY;
    ...
    public void ResetCameraRotationLimits()
    {
        minXRotation = -360f;
        maxXRotation = 360f;
        minYRotation = -90f;
